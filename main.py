...
Genera un mensaje de confirmación corto (máximo 3 oraciones), personalizado, entusiasta y acorde al tipo de evento.
...
Genera un mensaje empático y persuasivo (máximo 3 oraciones) para que el usuario no abandone la compra.
No menciones códigos técnicos. No uses markdown, solo texto plano."""
...
def procesar_evento(ch, method, properties, body):
    try:
        ...
        mensaje_llm = response.text.strip()
